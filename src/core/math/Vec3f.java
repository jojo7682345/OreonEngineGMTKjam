...
public class Vec3f {
	...
	public static Vec3f fromString(String split) {
		String s = split.replace("[", "").replace("]","");
		String[] data = s.split(",");
		return new Vec3f(Float.parseFloat(data[0]),Float.parseFloat(data[1]),Float.parseFloat(data[2]));
	}
